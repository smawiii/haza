...
const youtube = new YouTube("AIzaSyD40A2zUqAQRHzOOczFcO6GoPwQHnOygMc"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyD40A2zUqAQRHzOOczFcO6GoPwQHnOygMc"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@622046776605671465>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage(""
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "setby")) {
    ...
    client.on("guildMemberAdd", member => {
      ...
      var channel = member.guild.channels.find(gg => gg.name ==="『⛔』السـجـلات");
      if (!channel) return;
